...
#./mjpg_streamer -i "input_opencv.so -filter cvfilter_py.so -fargs /home/jun/mjpg/mjpg-streamer/mjpg-streamer-experimental/plugins/input_opencv/filters/cvfilter_py/Main_filter.py" -o "output_http.so -w ./www"
