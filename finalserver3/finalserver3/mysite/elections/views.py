...
def emotion():
	...
	while True:
		...
		# image_url = 'https://192.168.0.11:8000/static/image/face.jpg'
		headers = {'Content-Type': 'application/octet-stream', 'Ocp-Apim-Subscription-Key': subscription_key}
		# headers = {'Ocp-Apim-Subscription-Key': subscription_key}
		data = open('C:/Users/L/Desktop/finalserver3/mysite/wowowowowowowowow.png','rb')
		params = {
			'returnFaceId': 'false',
...
hostip = "192.168.0.11:8000"
maincamip = '"http://169.254.202.201:8080/?action=stream"'
babycamip = '"http://192.168.0.30:8080/?action=stream"'
ending = ""
...
t1 = threading.Thread(target=videoemotion.emotioncap, args=(), daemon = True)
